...
> Should report version number.

    {
      ...
      result: {
        errorCode: null,
        stderr: '',
        stdout: `@lntvow/sort-package-json 0.0.1␊
        `,
      },
    }
...
> Should keep scripts order by default.
...
## run `cli --sort-scripts` with no patterns

> Should sort scripts when --sort-scripts is provided.
